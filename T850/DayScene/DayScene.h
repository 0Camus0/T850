...
class DayScene : public t850::SceneBase
{
  ...
  float m_benchmarkTargetDurationSeconds = 0.0f;
  float m_benchmarkTimelineElapsedSeconds = 0.0f;
  bool m_benchmarkTimelineReachedEnd = false;
  bool m_benchmarkWallClockStarted = false;
  std::chrono::steady_clock::time_point m_benchmarkWallClockStart;
