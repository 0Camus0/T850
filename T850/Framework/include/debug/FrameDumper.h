...
namespace t850 {
  ...
  struct SnapshotScenePropsJson {
    ...
    std::optional<int> luminance_mode;
    ...
    std::optional<bool> deferred_light_volumes_enabled;
    std::optional<int> debug_deferred_lights_packed;
    std::optional<int> debug_deferred_lights_directional;
    std::optional<int> debug_deferred_lights_point_volumes;
    std::optional<int> debug_deferred_lights_considered;
    std::optional<int> debug_deferred_lights_active_limit;
    std::optional<int> debug_deferred_lights_scene_total;
    std::optional<int> debug_deferred_lights_frustum_culled;
    std::optional<int> debug_deferred_lights_disabled;
    std::optional<int> debug_deferred_lights_zero_intensity;
    std::optional<int> debug_deferred_lights_max_capped;
    std::optional<float> debug_deferred_light_volume_screen_percent;
    std::optional<int> debug_deferred_light_tiles_x;
    std::optional<int> debug_deferred_light_tiles_y;
    std::optional<int> debug_deferred_light_tile_count;
    std::optional<int> debug_deferred_light_tile_size;
    std::optional<int> debug_deferred_light_active_tiles;
    std::optional<int> debug_deferred_light_tile_light_refs;
    std::optional<float> debug_deferred_light_average_lights_per_tile;
    std::optional<int> debug_deferred_light_max_lights_in_tile;
    std::optional<int> debug_deferred_light_saturated_tiles;
