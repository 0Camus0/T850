...
public:
  ...
  void SetAuxiliaryGeometryEnabled(bool enabled) { m_auxiliaryGeometryEnabled = enabled; }
...
private:
  ...
  VertexBuffer* m_nodeVertexBuffer = nullptr;
  IndexBuffer* m_nodeIndexBuffer = nullptr;
  ...
  unsigned m_nodeVertexCapacity = 0;
  unsigned m_nodeIndexCapacity = 0;
  ...
  bool m_uploadedAuxiliaryGeometryEnabled = true;
  ...
  bool m_auxiliaryGeometryEnabled = true;

  std::vector<XVECTOR3> m_points;
  std::vector<unsigned int> m_indices;
  std::vector<float> m_vertices;
  std::vector<XVECTOR3> m_nodePoints;
