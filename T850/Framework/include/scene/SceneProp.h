...
struct SceneProps{
	SceneProps() : ActiveCamera(0) , ActiveLights(1), ActiveLightCamera(0), ActiveGaussKernel(0), Exposure(0.3f) , BloomFactor(0.35f), ToogleShadow(1), ToogleSSAO(1), DebugMode(0){}
