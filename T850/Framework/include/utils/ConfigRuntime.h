...
struct DevToolsJson {
  ...
  std::optional<bool> benchmarkMatrix;
  std::optional<bool> cullDisabled;
  std::optional<std::string> cullingMode;
  std::optional<std::string> benchmarkOutputPath;
  std::optional<std::string> benchmarkReportPath;
  std::optional<bool> benchmarkFinalFrameDump;
  std::optional<std::string> benchmarkFinalFrameDir;
  std::optional<int> benchmarkSeconds;
  std::optional<int> benchmarkDurationSeconds;
  std::optional<int> benchmarkFrameLimit;
  std::optional<float> benchmarkFixedDt;
