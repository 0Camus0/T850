...
int main(int argc, char** argv) {
  ...
  for (int i = 1; i < argc; ++i) {
    ...
    if (a == "--api" && i + 1 < argc) {
      std::string v = argv[++i];
      if      (v == "gl"    || v == "GL"    || v == "opengl" || v == "OpenGL") desc.api = t850::GraphicsApi::OPENGL;
      else if (v == "d3d12" || v == "D3D12" || v == "dx12")                    desc.api = t850::GraphicsApi::D3D12;
      else if (v == "d3d11" || v == "D3D11" || v == "dx11")                    desc.api = t850::GraphicsApi::D3D12;
    }
