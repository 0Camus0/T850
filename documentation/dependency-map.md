...
| External editor hosts/static extensions | [Editor SDK](editor/editor-sdk.md) | [Editor overview](editor/editor-overview.md), component factories, GameLogicSystem, PlayScenePanel |
| Heightmap placement cells, blockouts, and buildability | [Placement grid](terrain/placement-grid.md) | [Heightmap terrain](terrain/heightmap-terrain.md), [Navigation](navigation/navmesh-detour.md), [Editor tutorials](tutorials/README.md) |
